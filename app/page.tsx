...
export default function Home() {
  const schema = { "@context": "https://schema.org", "@type": "ProfessionalService", "@id": `${siteUrl}/#business`, url: siteUrl, name: "SiteSimple", description: "Done-for-you professional websites for small businesses.", priceRange: "$199–$799" };
